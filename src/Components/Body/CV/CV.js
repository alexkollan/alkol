    ...
    renderAll = () => {
      ...
      Object.keys(timeline).map((item, key)=>{
        ...
        switch (timeline[item].characteristic[0]) {
          case 'education':
            allEvents.push(<Element color='#095256' key={key} characteristic={timeline[item].characteristic} year={timeline[item].year} title={timeline[item].title} desc={timeline[item].description}/>)
            break;
            case 'hobbies':
            allEvents.push(<Element color='#005B4B' key={key} characteristic={timeline[item].characteristic} year={timeline[item].year} title={timeline[item].title} desc={timeline[item].description}/>)
            break;
            case 'life':
            allEvents.push(<Element color='#087F8C' key={key} characteristic={timeline[item].characteristic} year={timeline[item].year} title={timeline[item].title} desc={timeline[item].description}/>)
            break;
            case 'work':
            allEvents.push(<Element color='#022B3A' key={key} characteristic={timeline[item].characteristic} year={timeline[item].year} title={timeline[item].title} desc={timeline[item].description}/>)
            break;  
            case 'athletics':
            allEvents.push(<Element color='#005B4B' key={key} characteristic={timeline[item].characteristic} year={timeline[item].year} title={timeline[item].title} desc={timeline[item].description}/>)
            break;
