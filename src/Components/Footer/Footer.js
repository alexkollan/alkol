      ...
      return(
        <div className="footer">
          ...
          <Menu className="footMenu">
            <MenuItem onClick={() => this.goTo('fb')} className="footMenuItem"  text={<div style={{textAlign: 'center'}}><i className="devicon-facebook-plain footIcons"></i> Facebook</div>} />
              <MenuDivider />
            <MenuItem onClick={() => this.goTo('ln')} className="footMenuItem"  text={<div style={{textAlign: 'center'}}><i className="fa fa-linkedin" aria-hidden="true"></i> LinkedIn</div>} />
              <MenuDivider />
            <MenuItem  onClick={() => this.goTo('gh')} className="footMenuItem"  text={<div style={{textAlign: 'center'}}><i className="devicon-github-plain"></i> Github</div>} />
              <MenuDivider />
            <MenuItem onClick={() => this.goTo('cp')} className="footMenuItem"  text={<div style={{textAlign: 'center'}}><i className="fa fa-codepen" aria-hidden="true"></i> Codepen</div>} />
              <MenuDivider />
            <MenuItem onClick={() => this.goTo('cs')} className="footMenuItem"  text={<div style={{textAlign: 'center'}}><svg x="0px" y="0px" width="20px" height="20px" viewBox="0 0 1024 1024"><g id="Layer_1"><polyline fill="#FFFFFF" points="719.001,851 719.001,639.848 902,533.802 902,745.267 719.001,851"></polyline><polyline fill="#FFFFFF" points="302.082,643.438 122.167,539.135 122.167,747.741 302.082,852.573 302.082,643.438"></polyline><polyline fill="#FFFFFF" points="511.982,275.795 694.939,169.633 512.06,63 328.436,169.987 511.982,275.795"></polyline></g><g id="Layer_2"><polyline fill="none" stroke="#FFFFFF" strokeWidth="80" strokeMiterlimit="10" points="899,287.833 509,513 509,963"></polyline><line fill="none" stroke="#FFFFFF" strokeWidth="80" strokeMiterlimit="10" x1="122.167" y1="289" x2="511.5" y2="513"></line><polygon fill="none" stroke="#FFFFFF" strokeWidth="80" strokeMiterlimit="10" points="121,739.083 510.917,963.042 901,738.333 901,288 511,62 121,289"></polygon></g></svg> Codesandbox</div>} />
              <MenuDivider />
            <MenuItem onClick={() => this.goTo('lol')} className="footMenuItem" text={<div style={{textAlign: 'center'}}><i className="fa fa-code" aria-hidden="true"></i> This Site :O</div>} />
          </Menu>
            <h5><i><code>{'< Made with '}<i className="devicon-react-original"></i>{'ReactJS and '}{'@Blueprintjs '}{'using '}<i className="devicon-visualstudio-plain"></i>{' VScode,'}</code></i></h5>
            <h5><i><code>{'by Alex Kollan © 2018 />'}</code></i></h5>
          </MediaQuery>
